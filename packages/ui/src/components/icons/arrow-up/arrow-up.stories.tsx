...
import type { ArrowUpIconHandle } from "./arrow-up.icon";
...
const meta: Meta<typeof ArrowUpIcon> = {
  title: "Foundations/Icons/ArrowUpIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<ArrowUpIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <ArrowUpIcon ref={ref} size={CONTROLLED_SIZE} />
