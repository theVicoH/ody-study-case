...
import type { ArrowDownUpIconHandle } from "./arrow-down-up.icon";
...
const meta: Meta<typeof ArrowDownUpIcon> = {
  title: "Foundations/Icons/ArrowDownUpIcon",
...
type Story = StoryObj<typeof ArrowDownUpIcon>;
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<ArrowDownUpIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <ArrowDownUpIcon ref={ref} size={CONTROLLED_SIZE} />
