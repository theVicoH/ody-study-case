...
import type { ArrowRightIconHandle } from "./arrow-right.icon";
...
const meta: Meta<typeof ArrowRightIcon> = {
  title: "Foundations/Icons/ArrowRightIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<ArrowRightIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <ArrowRightIcon ref={ref} size={CONTROLLED_SIZE} />
