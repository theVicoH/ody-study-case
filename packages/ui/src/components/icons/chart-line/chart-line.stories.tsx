...
import type { ChartLineIconHandle } from "./chart-line.icon";
...
const meta: Meta<typeof ChartLineIcon> = {
  title: "Foundations/Icons/ChartLineIcon",
...
type Story = StoryObj<typeof ChartLineIcon>;
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<ChartLineIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <ChartLineIcon ref={ref} size={CONTROLLED_SIZE} />
