...
import type { MinimizeIconHandle } from "./minimize.icon";
...
const meta: Meta<typeof MinimizeIcon> = {
  title: "Foundations/Icons/MinimizeIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<MinimizeIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <MinimizeIcon ref={ref} size={CONTROLLED_SIZE} />
