...
import type { MaximizeIconHandle } from "./maximize.icon";
...
const meta: Meta<typeof MaximizeIcon> = {
  title: "Foundations/Icons/MaximizeIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<MaximizeIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <MaximizeIcon ref={ref} size={CONTROLLED_SIZE} />
