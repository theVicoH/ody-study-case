...
import type { BookmarkCheckIconHandle } from "./bookmark-check.icon";
...
const meta: Meta<typeof BookmarkCheckIcon> = {
  title: "Foundations/Icons/BookmarkCheckIcon",
...
type Story = StoryObj<typeof BookmarkCheckIcon>;
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<BookmarkCheckIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <BookmarkCheckIcon ref={ref} size={CONTROLLED_SIZE} />
