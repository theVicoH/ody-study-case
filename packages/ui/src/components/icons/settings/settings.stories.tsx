...
import type { SettingsIconHandle } from "./settings.icon";
...
const meta: Meta<typeof SettingsIcon> = {
  title: "Foundations/Icons/SettingsIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<SettingsIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <SettingsIcon ref={ref} size={CONTROLLED_SIZE} />
