...
import type { HouseIconHandle } from "./home.icon";
...
const meta: Meta<typeof HouseIcon> = {
  title: "Foundations/Icons/HouseIcon",
  component: HouseIcon,
  tags: ["autodocs"],
  parameters: {
    layout: "centered"
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<HouseIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <HouseIcon ref={ref} size={CONTROLLED_SIZE} />
