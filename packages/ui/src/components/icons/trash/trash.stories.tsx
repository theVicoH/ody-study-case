...
import type { TrashIconHandle } from "./trash.icon";
...
const meta: Meta<typeof TrashIcon> = {
  title: "Foundations/Icons/TrashIcon",
  component: TrashIcon,
  tags: ["autodocs"],
...
export const CustomColor: Story = { args: { color: "hsl(var(--destructive))", size: 32 } };
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<TrashIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <TrashIcon ref={ref} size={CONTROLLED_SIZE} />
