...
import type { PencilIconHandle } from "./pencil.icon";
...
const meta: Meta<typeof PencilIcon> = {
  title: "Foundations/Icons/PencilIcon",
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<PencilIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <PencilIcon ref={ref} size={CONTROLLED_SIZE} />
