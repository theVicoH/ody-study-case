...
import type { UsersIconHandle } from "./users.icon";
...
const meta: Meta<typeof UsersIcon> = {
  title: "Foundations/Icons/UsersIcon",
  component: UsersIcon,
  tags: ["autodocs"],
  parameters: {
    layout: "centered"
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<UsersIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <UsersIcon ref={ref} size={CONTROLLED_SIZE} />
