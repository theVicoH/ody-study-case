...
import type { SlidersHorizontalIconHandle } from "./sliders-horizontal.icon";
...
const meta: Meta<typeof SlidersHorizontalIcon> = {
  title: "Foundations/Icons/SlidersHorizontalIcon",
...
type Story = StoryObj<typeof SlidersHorizontalIcon>;
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<SlidersHorizontalIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <SlidersHorizontalIcon ref={ref} size={CONTROLLED_SIZE} />
