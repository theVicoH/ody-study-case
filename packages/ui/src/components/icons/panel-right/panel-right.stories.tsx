...
import type { PanelRightIconHandle } from "./panel-right.icon";
...
const meta: Meta<typeof PanelRightIcon> = {
  title: "Foundations/Icons/PanelRightIcon",
...
type Story = StoryObj<typeof PanelRightIcon>;
...
const ControlledRender = (): React.JSX.Element => {
  const ref = useRef<PanelRightIconHandle>(null);

  return (
    <div className="flex flex-col items-center gap-4">
      <PanelRightIcon ref={ref} size={CONTROLLED_SIZE} />
